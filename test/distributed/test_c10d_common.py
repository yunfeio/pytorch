...
class DummyProcessGroupExt(dist.ProcessGroup):
    def __init__(self, *args, **kwargs):
        # super(DummyProcessGroupExt, self).__init__(*args, **kwargs)
...
class PythonProcessGroupExtensionTest(MultiProcessTestCase):
    ...
    @patch.object(dist.ProcessGroup, "_register_backend")
    @patch.object(dist.ProcessGroup, "_get_backend")
    @patch.object(dist.ProcessGroup, "group_name", "custom")
    def test_comm_split_group(self, mock_get_backend, mock_register_backend):
        dist.Backend.register_backend(
            "dummy",
        ...
        mock_register_backend.return_value = None
        ...
        mock_get_backend.return_value = DummyProcessGroupExt(
            split_group_rank, split_group_size
        )
        all_group_ranks = [
        ...
        if split_pg is not None:
            self.assertEqual(dist.get_group_rank(split_pg, self.rank), split_group_rank)
