...
if not [%XPU_VERSION%]==[] if [%XPU_VERSION%]==[2025.1] (
    set XPU_BUNDLE_URL=https://registrationcenter-download.intel.com/akdlm/IRC_NAS/ea066288-d29c-4093-918c-6a488aef433d/intel-deep-learning-essentials-2025.1.0.580_offline.exe
    set XPU_BUNDLE_VERSION=2025.1.0+564
)
